...
3. Herencia: La herencia permite que una clase (subclase o clase derivada) herede atributos y métodos de otra clase (superclase o clase base). Esto fomenta la reutilización de código y la extensibilidad.

4. Polimorfismo: El polimorfismo permite que diferentes clases compartan un mismo nombre de método pero tengan implementaciones específicas. Esto facilita el manejo de objetos de diferentes tipos a través de una interfaz común.
